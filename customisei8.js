...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('redButton').addEventListener('click', function() {
        ...
        carImage.src = 'images/i8_white.png';
    });
