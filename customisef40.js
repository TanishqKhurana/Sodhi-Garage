...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('redButton').addEventListener('click', function() {
        ...
        carImage.src = 'images/f40_red.png';
    });
